...
public class RegressionTest extends TestAnnotation {
	...
	public void resetPassword() {
		String resetEmailId = common.readExcel("get_values",
				"passwordResetEmail");
		String resetPasswordMessage = common.readExcel("get_values",
	...
	public void invalidPassword() {
		try {
			...
			Assert.assertEquals(log.invalidLoginMess.getText(),
